import os
import numpy as np
from io_utils.visualization import save_visualization, draw_front, draw_fire_regions
from io_utils.csv_writer import save_to_csv

def create_result_handler_callback(output_dir: str):
    def callback(img_path: str, img: np.ndarray, mask: np.ndarray, front: np.ndarray):
        ...
        vis = draw_fire_regions(img, mask)
